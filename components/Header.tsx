          ...
          {!isHomePage && (
            <div className="hidden md:flex flex-1 max-w-sm relative group">
              <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-zinc-500">
                <span className="text-xs">Search icons...</span>
              </div>
              <div className="w-full bg-zinc-900 border border-zinc-800 rounded-lg h-9 flex items-center justify-end px-3">
                <div className="bg-zinc-800 px-1.5 py-0.5 rounded text-[10px] text-zinc-500 font-mono">⌘K</div>
              </div>
            </div>
          )}
